...
import com.shinnal.spring.test.thymeleaf.domain.Member;
...
//		List<Map<String, Object>> members = new ArrayList<>(); // Map으로 만들기!!
//
//		Map<String, Object> member = new HashMap<>();
//		member.put("name", "유비");
//		member.put("phoneNumber", "010-1234-5678");
//		member.put("email", "youbee@gmail.com");
//		member.put("nationality", "삼국시대 촉한");
//		member.put("introduce", "저는 촉의 군주 유비입니다. 삼국통일을 위해 열심히 일하겠습니다.");
//		member.put("birth", LocalDate.of(161, 7, 9));
//		members.add(member);
//
//		member = new HashMap<>();
//		member.put("name", "관우");
//		member.put("phoneNumber", "010-1234-5678");
//		member.put("email", "woo@naver.com");
//		member.put("nationality", "삼국시대 촉한");
//		member.put("introduce", "관우에요. 저는 유비형님 보다 나이는 많지만 일단 아우입니다.");
//		member.put("birth", LocalDate.of(160, 6, 14));
//		members.add(member);
//
//		member = new HashMap<>();
//		member.put("name", "장비");
//		member.put("phoneNumber", "02-111-3333");
//		member.put("nationality", "삼국시대 촉한");
//		member.put("email", "tools@gmail.com");
//		member.put("introduce", "장비라우");
//		member.put("birth", LocalDate.of(165, 1, 31));
//		members.add(member);
//
//		member = new HashMap<>();
//		member.put("name", "조조");
//		member.put("phoneNumber", "010-0987-4321");
//		member.put("nationality", "삼국시대 위");
//		member.put("email", "jojo@gmail.com");
//		member.put("introduce", "이름은 조조 자는 맹덕이라 하오");
//		member.put("birth", LocalDate.of(155, 5, 3));
//		members.add(member);
//
//		member = new HashMap<>();
//		member.put("name", "주유");
//		member.put("phoneNumber", "010-0000-1111");
//		member.put("nationality", "삼국시대 오");
//		member.put("email", "jooyou@kakao.com");
//		member.put("introduce", "주유는 주유소에서 ㅋㅋ");
//		member.put("birth", LocalDate.of(175, 5, 10));
//		members.add(member);
//
//		member = new HashMap<>();
//		member.put("name", "황충");
//		member.put("phoneNumber", "031-432-0000");
//		member.put("nationality", "삼국시대 촉한");
//		member.put("email", "yellowbug@naver.com");
//		member.put("introduce", "내 수염 좀 멋있는 듯");
//		member.put("birth", LocalDate.of(143, 8, 22));
//		members.add(member);
//
//		model.addAttribute("members", members);
		
		
		List<Member> members = new ArrayList<>(); // 도메인- 객체를 만들어서 연결해주기!!!
		...
		return "thymeleaf/ThymeleafTest03";
